...
import com.jwtgateway.project.configuration.security.support.ServerHttpBearerAuthenticationConverter;
import com.jwtgateway.project.configuration.security.support.ServerHttpCookieAuthenticationConverter;
...
//    @Bean
//    public SecurityWebFilterChain securityWebFilterChain(HttpSecurity http, AuthenticationManager authManager) throws Exception {
//        return http
//                .sessionManagement()
